...
@Component({
  selector: 'app-addfirstoutlet',
  templateUrl: './addfirstoutlet.component.html',
  styleUrls: ['./addfirstoutlet.component.scss']
})

export class AddfirstoutletComponent implements OnInit {
  message: any;
  arr:any;
  images:any
  moutletArr = [];
  ...
  addimage(){
    ...
    this.http.post('http://165.22.50.213:3001/upmoutletandimage', formData).subscribe(res =>{
      ...
      if(this.message['success'] == false){
        ...
        var mlogin =JSON.parse(localStorage.getItem('Mlogin') !);
          this.http.post('http://165.22.50.213:3001/getmoutlet',mlogin).subscribe((res:any) => {
          console.log(res)
